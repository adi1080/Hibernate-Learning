	...
	public static SessionFactory getSessionFactory()
	{
		try {
			if(sf==null)
			{
				...
				map.put(Environment.JAKARTA_JDBC_URL, "jdbc:mysql://localhost:3306/hib-onetomany-manytoone");
				...
				mds.addAnnotatedClass(Employee.class);    //change student with ur entity class
