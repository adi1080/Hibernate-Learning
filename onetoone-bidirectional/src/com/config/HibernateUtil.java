	...
	public static SessionFactory getSessionFactory()
	{
		try {
			if(sf==null)
			{
				...
				map.put(Environment.JAKARTA_JDBC_URL, "jdbc:mysql://localhost:3306/hib-one2one_bidirection");
				...
				mds.addAnnotatedClass(AdharCard.class);    //change student with ur entity class
